            ...
            <div className="grid grid-cols-1 sm:grid-cols-2  gap-8">
              ...
              <div className="relative rounded-md overflow-hidden shadow-lg border border-amber-300/40 text-[#fef3c7]">
                ...
                <div className="relative px-4 sm:px-6 py-6 flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-base sm:text-lg leading-relaxed opacity-95 mb-5">
                    Neue Speisekarte mit traditionellen hessischen Speisen.
                    <br />
                    Unsere Küche steht unter neuer Leitung!
                    <br />
              ...
              {/* <div className="relative rounded-md overflow-hidden shadow-lg border border-amber-300/40 text-[#fef3c7]">
                ...
                <div className="relative px-4 sm:px-6 py-6 flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-base sm:text-lg leading-relaxed opacity-95 mb-5">
                    Sonntags bieten wir häufig ein Buffet an.
                    <br />
                    Bitte beachten Sie unsere aktuellen
                    <br />
                    Aktionsankündigungen für die jeweiligen Angebote.
                    <br />
                    Brunchbuffet, Galabuffet, Sonntagsbuffet,
                    <br />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Im Gasthaus Rudolph erleben Sie authentische deutsche Küche
              gepaart mit einer eigenen Apfelwein‑Kelterei
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <p className="text-gray-600">
                Hausgemachter Apfelkuchen, regionale Speisen wie Wildgerichte
                oder Grüne Soße, stets frisch von der Tageskarte
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">
                Events bis 300 Gäste
              </h3>
              <p className="text-gray-600">
                Ideal für Familienfeiern, Jubiläen, Hochzeiten oder
                Firmen‑Events mit vielseitigen Räumlichkeiten
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">
                Wintergarten & Biergarten
              </h3>
              <p className="text-gray-600">
                Überdachter Wintergarten mit öffnungsfähigem Dach sowie
                großzügiger Biergarten für jede Jahreszeit
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-serif text-4xl font-bold text-gray-900 mb-6">
                Willkommen im Gasthaus Rudolph
              </h2>

              <blockquote className="text-xl text-amber-700 font-serif italic mb-6 border-l-4 border-amber-500 pl-4">
                Tradition schmecken – wie bei Oma.
              </blockquote>

              <p className="text-lg text-gray-700 mb-8">
                Seit 1620 heißt das Gasthaus Rudolph seine Gäste mit echter
                deutscher Gastfreundschaft und traditioneller hessischer Küche
                willkommen und bewahrt damit ein kulinarisches Erbe, das über
              ...
              <p className="text-lg text-gray-700 mb-8">
                Unser Ebbler ist en gude Schoppe aus der Region. Es erwarten Sie
                täglich frisch zubereitete Speisen von der Tageskarte, serviert
                in familiärer Gastlichkeit.
              </p>
              {/* <p className="text-lg text-gray-700 mb-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              Grillparty oder Firmenfest – das Gasthaus Rudolph bietet für jede
              Feier den idealen Rahmen
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Großzügiger Biergarten mit traditionellen Außenbereichen für
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Wetterunabhängiger Wintergarten mit öffnungsfähigem Dach für
                  bis zu 100 Personen
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Vielseitige Räumlichkeiten im historischen Fachwerkhaus für
                  besondere Anlässe
                </p>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <blockquote className="text-xl text-amber-700 font-serif italic mb-8">
            Authentische Hessische Hausmannskost
          </blockquote>

          <div className="max-w-4xl mx-auto text-lg text-gray-700 leading-relaxed space-y-6">
            <p>
              Unser Konzept ist einfach: Wir servieren authentische hessische
              Hausmannskost – wie in guten alten Zeiten. Dabei greifen wir auf
              überlieferte Rezepte zurück und bewahren so ein kulinarisches
              Erbe, das nicht in Vergessenheit geraten darf.
            </p>

            <p>
              Frische und Regionalität stehen dabei bei uns immer an erster
              Stelle. Unsere Zutaten stammen bevorzugt aus Hessen – von
              regionalen Viehzüchtern, Landwirten und Erzeugern. So garantieren
              wir Frische, Qualität und Nachhaltigkeit.
            </p>

            <p>
              Lediglich bei Engpässen – etwa wegen Ernteausfällen, Streiks usw.
              – setzen wir ausschließlich geprüfte, hochwertige
              Konvenienz-Produkte ein, die allerdings den hohen Standards
              unseres Küchenchefs entsprechen müssen.
            </p>
          </div>
        </div>
      </section>
