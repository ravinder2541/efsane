                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600 space-y-1">
                      <p>
                        <strong>Monday:</strong> <span className="text-red-600">Closed</span>
                      </p>
                      <p>
                        <strong>Tuesday - Saturday:</strong> 4:00 PM - 10:00 PM
                      </p>
                      <p>
                        <strong>Sunday (May - Oct):</strong> 12:00 PM - 10:00 PM
                      </p>
                      <p>
                        <strong>Sunday (Nov - Apr):</strong> 11:00 AM - 4:00 PM
                      </p>
                    </div>
                  </div>
                </div>
